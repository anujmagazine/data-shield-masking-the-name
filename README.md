...
The detection uses a 7-tier strategy, tested against all 143 OGQ para athlete names with 100% masking coverage:

1. **Labeled names** — names after `Athlete:`, `Coach:`, `Dr.`, `Signed by:`, `Reviewed by:`, etc.
